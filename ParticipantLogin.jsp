...
<html lang="en" dir="ltr">
  <head>
	...
	*{
	...
	html,body{
	  height: 100%;"WebContent/ParticipantLogin.jsp"
	  width: 100%;
	  place-items: center;
	  background: #f2f2f2;
	...
	<script>
		function gotoParticipantRegistration(){
			window.location = "ParticipantRegistration.jsp";
		}
		function gotoHome(){
...
<body>
    ...
    <div class="wrapper">
      <div class="title">Participant Login</div>
      <form action="ParticipantLoginServlet" method="post">
        <div class="field">
        <%
        ...
        <div class="signup-link">Not a Participant? <a onclick="gotoParticipantRegistration()" href="#">Register now</a></div>
      </form>
    </div>
  </body>
</html>
